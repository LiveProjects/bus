...
// if ($act == 'check') {
	...
	$sql_com = "select  a.FID as id_emp, a.FName as name_emp,b.FName as name_com from t_hs_employee a inner join t_hs_company b on a.FCompanyID=b.FID where a.FName='{$name_emp}'";
